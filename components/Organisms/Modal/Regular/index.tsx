  ...
  return (
    <>
      ...
      {isOpen && (
        <>
          <div
            className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-light-gray dark:bg-dark-gray min-w-48 min-h-48 rounded-xl z-30 shadow-lg p-4 ${modalAnimation}`}
            ref={ref}
          >
