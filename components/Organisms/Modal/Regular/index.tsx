  ...
  return (
    <>
      ...
      {isOpen && (
        <>
          <div
            className={`fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-light-gray dark:bg-dark-gray min-w-48 min-h-48 w-11/12 md:w-auto rounded-xl z-30 shadow-lg p-4 ${modalAnimation}`}
            ref={ref}
          >
